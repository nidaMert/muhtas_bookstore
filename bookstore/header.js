...
<header>
                    <div class="top-header">
                        <ul>
                            <li class="logo"><img src="Group 6logo.svg"></li>
                            <li>
                            ...
                            <li>
                              <div class="right-side-container">
                                <a href="#" class="cart"><img src="cart.svg"></a>
                                <a href="#" class="favourite"><img src="favourite.svg"></a>
                                <a href="login.html" class="user_circle"><img src="user_circle.svg"></a>
                              </div>
                            </li>
                        </ul>
                    </div>
