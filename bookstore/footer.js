        ...
        <div class="row">
          ...
          <div class="footer-column">
            <ul class="footer-right-side-container1">
              <li><a href="#" class="order_tracking"><img src="order_tracking.svg"></a></li>
              <li><a href="#" class="whatsapp"><img src="whatsapp.svg"></a></li>
            </ul>
            <ul class="footer-right-side-container2">
              ...
              <ul class="social-media-icons">
                <li><a href="#" class="instagram"><img src="instagram.svg"></a></li>
                <li><a href="#" class="facebook"><img src="facebook.svg"></a></li>
                <li><a href="#" class="twitter"><img src="twitter.svg"></a></li>
              </ul>
            </ul>
          </div>
      </div>
